...
function ResolutionCard({ resolution, showVotes = false }: Props) {
  return (
    <div className="flex flex-col gap-6 p-7 rounded-3xl bg-near-white shadow-3xl shadow-lxl shadow-dark-neutral/10">
        ...
        {showVotes ? (
          <div className="flex gap-6">
            <div className="flex flex-col gap-0 justify-center items-center">
              <span className="text-lg font-bold">{resolution.agree_vote}</span>
              <span className="text-sm">agree</span>
            </div>
            <div className="flex flex-col gap-0 justify-center items-center">
              <span className="text-lg font-bold">{resolution.disagree_vote}</span>
              <span className="text-sm">disagree</span>
            </div>
            <div className="flex flex-col gap-0 justify-center items-center">
              <span className="text-lg font-bold">{resolution.abstain_vote}</span>
