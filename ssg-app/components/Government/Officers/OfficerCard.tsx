  ...
  return (
    (isMobile) ? (
      <div
        ...
        className="w-full rounded-4xl bg-near-white flex gap-4 p-2 items-center border border-light-neutral">
        ...
        <div className="flex flex-col">
          <span className="font-serif text-lg font-medium text-dark-neutral">
